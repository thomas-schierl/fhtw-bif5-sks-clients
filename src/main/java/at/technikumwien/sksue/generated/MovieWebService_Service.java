 ...
 * 
 */
@WebServiceClient(name = "MovieWebService", targetNamespace = "http://services.sksue.technikumwien.at/", wsdlLocation = "http://localhost:8080/sksuebung/MovieWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MOVIEWEBSERVICE_QNAME = new QName("http://services.sksue.technikumwien.at/", "MovieWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/sksuebung/MovieWebService?wsdl");
    ...
    public MovieWebService getMovieWebServicePort() {
        return super.getPort(new QName("http://services.sksue.technikumwien.at/", "MovieWebServicePort"), MovieWebService.class);
    }
    ...
    public MovieWebService getMovieWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.sksue.technikumwien.at/", "MovieWebServicePort"), MovieWebService.class, features);
    }
